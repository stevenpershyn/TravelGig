...
<div class="col-7 border rounded" style="margin-left:50px;">
	...
	<div id="listHotel">
		<table id='hotelTbl' border='1'><tr class='header'><th>Hotel Name</th><th>Hotel Price</th><th>Hotel Rating</th><th>Hotel Amenities</th><th>Image</th></tr></table>
	</div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">        
        <div class="col">
        	...
        	<input style="margin-top:25px" class="btn btn-searchHotelRooms form-control btn-primary" type="button" id="guestBtn" value="SEARCH"/>       	
        </div>
      ...
      <div class="modal-body" id="bookingRoom_modalBody">        
        	<div class="col">
	        	...
	        	<div>Customer Mobile: <input class="form-control" type="text" id="booking_customerMobile"/></div>
       			...
       			<div><input class="form_control" type="hidden" id="booking_guests"/></div>
       			...
       			<div style='margin-top:20px'>
       				<button class='btn-confirm-booking btn btn-primary' id="saveBookingBtn">Confirm Booking</button>
       				<button class='btn btn-primary' id="editBookingBtn">Edit</button>
       			</div>
        	</div>          
      </div>
...
<div class="modal" id="guestDetailsModal">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<!-- Modal footer -->
      		<div class="modal-footer">
      			<input style="margin-top:25px" class="btn btn-searchHotelRooms form-control btn-primary" type="button" id="prepareBookingBtn" value="SEARCH"/>
        		<button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
      		</div>
		</div>
	</div>
